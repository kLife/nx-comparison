...
(function() {
	...
	var _messages = {
		...
		en: {
			...
			exclude_not_exist_nx: "Exclude non-NX items",
			search_form_button: "Search",
			search_form_placeholder: "Item name",
			image_download_button: "Save as image",
			loading_error_message1: "Refresh the page if loading doesn't end.",
			loading_error_message2: "If reloading doesn't work, please report what browser you're using in the comments.",
